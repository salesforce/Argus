...
public class ReducersScannerTest extends AbstractTest {
	...
	@Test
	public void testSumReducerWithoutNull() {
		...
		for (int i = 0; i < metrics.size(); i++) {
			Double expected = Reducers.sumReducer(new ArrayList<>(metrics.get(i).getDatapoints().values()));
			Double actual = Reducers.sumReducerScanner(scanners.get(i));
	...
	@Test
	public void testSumReducerWithNull() {
	...
	@Test
	public void testSumReducerAllNull() {
