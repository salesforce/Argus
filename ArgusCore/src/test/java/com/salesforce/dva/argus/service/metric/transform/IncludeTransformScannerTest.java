...
public class IncludeTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testTransformWithRegexIncludesMatch() {
		...
		IncludeTransform transform = new IncludeTransform();
	...
	@Test
	public void testTransformWithRegexDoesNotIncludesMatch() {
	...
	@Test
	public void testDisposeOfUnusedScanners() {
	...
	public void testPager() {
		...
		Transform transform = new IncludeTransform();
		List<String> constants = new ArrayList<>();
		constants.add(TEST_INCLUDE_REGEX);
