...
public class MetricSchemaRecordTokenizerTest {
    ...
    public void testMetricTokensLevelZero() {
        ...
        SortedSet<String> scopes = MetricSchemaRecordTokenizer.GetUniqueTokens(records, SchemaService.RecordType.METRIC, 0);

        assertTrue(scopes.size() == 5);
        assertTrue(scopes.contains("metric0"));
        assertTrue(scopes.contains("metric4"));
    }
}
