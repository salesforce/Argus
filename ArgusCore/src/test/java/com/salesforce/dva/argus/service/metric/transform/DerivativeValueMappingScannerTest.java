...
public class DerivativeValueMappingScannerTest extends AbstractTest {
	...
	@Test
	public void testDerivativeMapping() {
		...
		DerivativeValueMapping map = new DerivativeValueMapping();
		
		for (int i = 0; i < metrics.size(); i++) {
			Map<Long, Double> expected = map.mapping(metrics.get(i).getDatapoints());
	...
	public void testPager() {
		...
		ValueMapping mapping = new DerivativeValueMapping();
