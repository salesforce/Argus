...
public class MetricFilterWithInteralReducerTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testTransformWithConstantsDefaultTypeRandomLimitWithAboveValueFilterWithoutNull() {
		...
		ValueFilter filter = new AboveValueFilter();
		MetricFilterWithInteralReducerTransform transform = new MetricFilterWithInteralReducerTransform(filter);
	...
	@Test
	public void testTransformWithConstantsDefaultTypeRandomLimitWithAboveValueFilterWithNull() {
	...
	@Test
	public void testTransformWithConstantsTypeAverageLimitWithAboveValueFilterWithoutNull() {
	...
	@Test
	public void testTransformWithConstantsTypeAverageLimitWithAboveValueFilterWithNull() {
	...
	@Test
	public void testTransformWithConstantsTypeDefaultLimitWithLowestValueFilterWithoutNull() {
		...
		ValueFilter filter = new LowestValueFilter();
		MetricFilterWithInteralReducerTransform transform = new MetricFilterWithInteralReducerTransform(filter);
		List<String> constants = new ArrayList<>();
		constants.add("" + random.nextInt(100));
	...
	@Test
	public void testTransformWithConstantsTypeMinLimitWithAboveValueFilterWithoutNull() {
	...
	@Test
	public void testTransformWithConstantsTypeMinLimitWithBelowValueFilterWithNull() {
		...
		ValueFilter filter = new BelowValueFilter();
		MetricFilterWithInteralReducerTransform transform = new MetricFilterWithInteralReducerTransform(filter);
		List<String> constants = new ArrayList<>();
		constants.add("" + random.nextDouble() * 100); // make this super low so that we get results
		constants.add("min");
	...
	@Test
	public void testTransformWithConstantsTypeMaxLimitWithAboveValueFilterWithoutNull() {
	...
	@Test
	public void testTransformWithConstantsTypeMaxLimitWithAboveValueFilterWithNull() {
	...
	@Test
	public void testTransformWithConstantsTypeNameLimitWithHighestValueFilterWithoutNull() {
		...
		ValueFilter filter = new HighestValueFilter();
		MetricFilterWithInteralReducerTransform transform = new MetricFilterWithInteralReducerTransform(filter);
		List<String> constants = new ArrayList<>();
		constants.add("" + random.nextInt(100));
		constants.add("name");
	...
	@Test
	public void testTransformWithConstantsTypeNameLimitWithHighestValueFilterWithNull() {
	...
	@Test
	public void testTransformWithConstantsTypeDeviationLimitWithHighestValueFilterWithoutNull() {
	...
	@Test
	public void testTransformWithConstantsTypeDeviationLimitWithHighestValueFilterWithNull() {
	...
	@Test
	public void testTransformWithConstantsTypeRecentLimitWithHighestValueFilterWithoutNull() {
	...
	@Test
	public void testTransformWithConstantsTypeRecentLimitWithHighestValueFilterWithNull() {
	...
	@Test
	public void testDPIntegrityAndDisposalWithAvg() {
	...
	@Test
	public void testDPIntegrityAndDisposalWithName() {
	...
	public void testPagerAvg() {
		...
		Transform transform = new MetricFilterWithInteralReducerTransform(new AboveValueFilter());
		List<String> constants = new ArrayList<>();
		constants.add("25.0");
	...
	public void testPagerName() {
		...
		Transform transform = new MetricFilterWithInteralReducerTransform(new HighestValueFilter());
		List<String> constants = new ArrayList<>();
		constants.add("" + random.nextInt(100));
		constants.add("name");
		Long chunkTime = (max - min) / 7;				
