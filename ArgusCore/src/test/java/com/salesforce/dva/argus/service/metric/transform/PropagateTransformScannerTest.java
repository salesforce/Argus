...
public class PropagateTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testPropagateTransformNoNullSmallWindow() {
		...
		Transform transform = new PropagateTransform();
	...
	@Test
	public void testPropagateTransformNoNullLargeWindow() {
	...
	@Test
	public void testPropagateTransformLastNullSmallWindow() {
		...
		for (Metric m : metrics) {
			...
			Long timestamp = Collections.max(dps.keySet());
	...
	@Test
	public void testPropagateTransformLastNullLargeWindow() {
	...
	@Test
	public void testPropagateTransformMiddleNullSmallWindow() {
	...
	@Test
	public void testPropagateTransformMiddleNullLargeWindow() {
