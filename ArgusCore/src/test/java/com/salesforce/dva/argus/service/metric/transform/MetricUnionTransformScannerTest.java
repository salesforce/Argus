...
public class MetricUnionTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testMetricUnionFullListWithAverageValueReducer() {
		...
		ValueReducer reducer = new AverageValueReducer();
		MetricUnionTransform transform = new MetricUnionTransform(reducer);
		
		List<Metric> expected = transform.union(metrics);
		List<Metric> actual = transform.unionScanner(scanners);
		
		assert(expected.equals(actual));
	}
	
	@Test
	public void testMetricUnionFullListWithMaxValueReducer() {
		...
		ValueReducer reducer = new MaxValueReducer();
		MetricUnionTransform transform = new MetricUnionTransform(reducer);
	...
	@Test
	public void testMetricUnionEmptyListWithAverageValueReducer() {
	...
	@Test
	public void testTransformNoConstantsMaxValueReducer() {
	...
	@Test
	public void testTransformNoConstantsCountValueUnionReducer() {
		...
		ValueReducer reducer = new CountValueUnionReducer();
		MetricUnionTransform transform = new MetricUnionTransform(reducer);
	...
	public void testPager() {
		...
		Transform transform = new MetricUnionTransform(new CountValueUnionReducer());
