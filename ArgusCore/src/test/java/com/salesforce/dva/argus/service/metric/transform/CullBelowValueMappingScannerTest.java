...
public class CullBelowValueMappingScannerTest extends AbstractTest {
	...
	public void testCullAboveTransformPercentile() {
		...
		CullBelowValueMapping map = new CullBelowValueMapping();
	...
	public void testPager() {
		...
		ValueMapping mapping = new CullBelowValueMapping();
