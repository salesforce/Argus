...
public class MetricReducerTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testTransformNoConstantMaxValueReducer() {
		...
		Transform transform = new MetricReducerTransform(reducer);
	...
	@Test
	public void testTransformNoConstantAverageValueReducer() {
	...
	public void testPager() {
		...
		Transform transform = new MetricReducerTransform(new AverageValueReducer());
