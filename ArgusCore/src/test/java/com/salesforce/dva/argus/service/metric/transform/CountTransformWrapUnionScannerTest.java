...
public class CountTransformWrapUnionScannerTest extends AbstractTest {
	...
	public void testUnionTransformation() {
		...
		CountTransformWrapUnion transform = new CountTransformWrapUnion();
	...
	public void testPager() {
		...
		Transform transform = new CountTransformWrapUnion();
