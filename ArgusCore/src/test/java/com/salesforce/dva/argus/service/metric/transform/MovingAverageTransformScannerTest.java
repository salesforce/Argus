...
public class MovingAverageTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testTransformSmallWindowWithTimeInterval() {
		...
		MovingAverageTransform transform = new MovingAverageTransform();
	...
	@Test
	public void testTransformLargeWindowWithTimeInterval() {
	...
	@Test
	public void testTransformSmallWindowWithFixedNoOfPoints() {
		...
		MovingAverageTransform transform = new MovingAverageTransform();
		List<String> constants = new ArrayList<>();
		constants.add("" + 3L);	// take a window of three points
	...
	@Test
	public void testTransformLargeWindowWithFixedNoOfPoints() {
		...
		MovingAverageTransform transform = new MovingAverageTransform();
		List<String> constants = new ArrayList<>();
		constants.add("" + 100L);	// take a window of 100 points
