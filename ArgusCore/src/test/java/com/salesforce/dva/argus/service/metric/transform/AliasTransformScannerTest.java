...
public class AliasTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testTransformScannerRegexOnlyName() {
		...
		AliasTransform transform = new AliasTransform();
	...
	@Test
	public void testTransformScannerLiteralOnlyName() {
	...
	@Test
	public void testTransformScannerRegexNameAndScope() {
	...
	@Test
	public void testTransformScannerLiteralNameAndScope() {
		...
		AliasTransform transform = new AliasTransform();
		List<String> constants = new ArrayList<>();
        constants.add("test metric name");
        constants.add(TEST_TYPE_LITERAL);
        constants.add("test metric scope");
        constants.add(TEST_TYPE_LITERAL);
	...
	@Test
	public void testTransformScannerRegexNameLiteralScope() {
	...
	@Test
	public void testTransformScannerLiteralNameRegexScope() {
	...
	public void testPagerWithConstants() {
		...
		Transform transform = new AliasTransform();
		List<String> constants = new ArrayList<>();
        constants.add(TEST_ALIAS_REGEX);
        constants.add(TEST_TYPE_REGEX);
        constants.add(TEST_ALIAS_REGEX);
