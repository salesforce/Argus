...
public class DiffValueReducerOrMappingScannerTest extends AbstractTest {
	...
	@Test
	public void testDiffValueReducerWithoutNull() {
	...
	@Test
	public void testDiffValueReducerWithNull() {
	...
	@Test
	public void testDiffValueMapping() {
	...
	public void testPager() {
		...
		ValueReducerOrMapping redMap = new DiffValueReducerOrMapping();
		List<String> constants = new ArrayList<>();
		constants.add("25.0");
