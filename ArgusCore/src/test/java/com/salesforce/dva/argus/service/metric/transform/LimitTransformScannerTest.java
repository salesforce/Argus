...
public class LimitTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testIdentityTransformAllIncluded() {
		...
		LimitTransform transform = new LimitTransform();
		List<String> constants = new ArrayList<>();
		constants.add("" + (long) (metrics.size() + 1));
	...
	@Test
	public void testIdentityTransformHalfIncluded() {
		...
		LimitTransform transform = new LimitTransform();
		List<String> constants = new ArrayList<>();
		constants.add("" + (long) (metrics.size() / 2));
	...
	@Test
	public void testIdentityTransformNoneIncluded() {
	...
	@Test
	public void testIdentityTransformRandomIncluded() {
		...
		LimitTransform transform = new LimitTransform();
		List<String> constants = new ArrayList<>();
		constants.add("" + (long) random.nextInt(metrics.size()));
	...
	public void testPagerOneList() {
		...
		Transform transform = new LimitTransform();
		List<String> constants = new ArrayList<>();
		constants.add("" + random.nextInt(metrics.size()));		
