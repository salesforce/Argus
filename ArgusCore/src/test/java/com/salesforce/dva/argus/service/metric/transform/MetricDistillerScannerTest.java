...
public class MetricDistillerScannerTest extends AbstractTest {
	...
	@Test
	public void testMetricDistillerAttributes() {
		...
		MetricDistiller.setCommonAttributes(metrics, expected);
		MetricDistiller.setCommonScannerAttributes(scanners, actual);
		
		assert(actual.equals(expected));
	}
	
	@Test
	public void testMetricDistillerDistillAsList() {
		...
		for (int i = 0; i < metrics.size(); i++) {
			assert(metrics.get(i).equals(scanners.get(i).getMetric()));
		}
	}
