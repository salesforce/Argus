...
public class EmailNotifierTest {
    ...
    public void setup() {
        ...
        Notification notification = getNotification(EMAIL_NOTIFICATION_NAME, EMAIL_NOTIFIER_NAME, alert);
    ...
    public void testEmailNotificationWhenTheStatusIsTriggered() {
        ...
        when(mailServiceMock.sendMessage(subscriptionSet, expectedNotificationSubject , expectedNotificationBody,
                "text/html; charset=utf-8", MailService.Priority.NORMAL)).thenReturn(true);

        boolean isEmailSent = emailNotifier.sendAdditionalNotification(notificationContext);

        verify(mailServiceMock, times(1)).sendMessage(subscriptionSet, expectedNotificationSubject,
                expectedNotificationBody, "text/html; charset=utf-8",
                MailService.Priority.NORMAL);
    ...
    public void testEmailNotificationWhenTheNotificationIsNotSentOnClearedNotification() {
        ...
        when(mailServiceMock.sendMessage(subscriptionSet, expectedNotificationSubject , expectedNotificationBody,
                "text/html; charset=utf-8", MailService.Priority.NORMAL)).thenReturn(false);
    ...
    public void testSendingNotificationsWhenThereAreMultipleNotificationsForAnAlert() {
        ...
        Notification emailNotification = getNotification(EMAIL_NOTIFICATION_NAME, EMAIL_NOTIFIER_NAME, alert);
        alert.addNotification(emailNotification);

        Notification pagerDutyNotification = getNotification(PAGER_DUTY_NOTIFICATION_NAME, PAGER_DUTY_NOTIFIER_NAME, alert);
    ...
    private String getEmailBodyForSingleNotificationOnTriggered() {
        return "<h3>Alert " + ALERT_NAME + " was " + TRIGGERED + " at "+TRIGGER_FIRED_DATE_GMT + "</h3><b>Notification is on cooldown" +
                " until:  </b> 01/01/1970 00:00:00 GMT<br/><b>Evaluated metric expression:  </b> " +
                "-3600000:0:" + METRIC_NAME + "<br/><p><a href='http://localhost:8080/argus/#/viewmetrics?expression=" +
                "-3600000%3A0%3Aargus.jvm%3Acores.active%3Amax'>Click here to view the evaluated metric data.</a><br/><br/><p>" +
                "<a href='http://localhost:8080/argus/#/viewmetrics?expression=-1h%3Aargus.jvm%3Acores.active%3Amax'>Click" +
                " here for the current view of the metric data.</a><br/><br/><b>" + TRIGGERED + " on Metric:  </b>" +
                " " + METRIC_SCOPE_NAME + ":" + METRIC_NAME + "{source=unittest}<br/><b>Trigger details: </b> type=" + TRIGGER_TYPE + "," +
                " name=" + TRIGGER_NAME + ", threshold=" + TRIGGER_THRESHOLD + ", inertia=" + TRIGGER_INERTIA_MILLIS + "<br/><b>Triggering" +
                " event value:  </b> " + TRIGGER_EVENT_VALUE + "<br/><p><p><a href='http://localhost:8080/argus/#/alerts/null'>Click" +
                " here to view alert definition.</a><br/><p><small>Disclaimer:  This alert was evaluated using the time series" +
                " data as it existed at the time of evaluation.  If the data source has inherent lag or a large aggregation" +
                " window is used during data collection, it is possible for the time series data to be updated such that the" +
                " alert condition is no longer met.  This may be avoided by ensuring the time window used in alert expression" +
                " is outside the range of the datasource lag.</small><p><small>You received this notification because you, or" +
                " a distribution list you belong to is listed as a subscriber of the alert.</small>";
    }

    private String getEmailBodyForSingleNotificationOnCleared() {
        return "<h3>Alert " + ALERT_NAME + " was " + CLEARED + " at " + TRIGGER_FIRED_DATE_GMT + "</h3><b>Evaluated metric expression:  </b> " +
                "-3600000:0:" + METRIC_NAME + "<br/><p><a href='http://localhost:8080/argus/#/viewmetrics?expression=" +
                "-3600000%3A0%3Aargus.jvm%3Acores.active%3Amax'>Click here to view the evaluated metric data.</a><br/><br/><p>" +
                "<a href='http://localhost:8080/argus/#/viewmetrics?expression=-1h%3Aargus.jvm%3Acores.active%3Amax'>Click" +
                " here for the current view of the metric data.</a><br/><br/><b>" + CLEARED + " on Metric:  </b>" +
                " " + METRIC_SCOPE_NAME + ":" + METRIC_NAME + "{source=unittest}<br/><b>Trigger details: </b> type="+ TRIGGER_TYPE + "," +
                " name=" + TRIGGER_NAME + ", threshold=" + TRIGGER_THRESHOLD + ", inertia=" + TRIGGER_INERTIA_MILLIS + "<br/><p>" +
                "<p><a href='http://localhost:8080/argus/#/alerts/null'>Click" +
                " here to view alert definition.</a><br/><p><small>Disclaimer:  This alert was evaluated using the time series" +
                " data as it existed at the time of evaluation.  If the data source has inherent lag or a large aggregation" +
                " window is used during data collection, it is possible for the time series data to be updated such that the" +
                " alert condition is no longer met.  This may be avoided by ensuring the time window used in alert expression" +
    ...
    private String getEmailBodyForMultipleNotificationsOnTriggered() {
        return "<h3>Alert " + ALERT_NAME + " was " + TRIGGERED + " at "+TRIGGER_FIRED_DATE_GMT + "</h3><b>Notification:  </b> "
                + EMAIL_NOTIFICATION_NAME + "<br/><b>Notification is on cooldown" +
                " until:  </b> 01/01/1970 00:00:00 GMT<br/><b>Evaluated metric expression:  </b> " +
                "-3600000:0:" + METRIC_NAME + "<br/><p><a href='http://localhost:8080/argus/#/viewmetrics?expression=" +
                "-3600000%3A0%3Aargus.jvm%3Acores.active%3Amax'>Click here to view the evaluated metric data.</a><br/><br/><p>" +
                "<a href='http://localhost:8080/argus/#/viewmetrics?expression=-1h%3Aargus.jvm%3Acores.active%3Amax'>Click" +
    ...
    private String getEmailBodyForMultipleTriggersOnTriggered(String triggerName) {
        return "<h3>Alert " + ALERT_NAME + " was " + TRIGGERED + " at "+TRIGGER_FIRED_DATE_GMT + "</h3><b>Triggered by: " +
                " </b> " + triggerName + "<br/><b>Notification is on cooldown" +
                " until:  </b> 01/01/1970 00:00:00 GMT<br/><b>Evaluated metric expression:  </b> " +
                "-3600000:0:" + METRIC_NAME + "<br/><p><a href='http://localhost:8080/argus/#/viewmetrics?expression=" +
                "-3600000%3A0%3Aargus.jvm%3Acores.active%3Amax'>Click here to view the evaluated metric data.</a><br/><br/><p>" +
                "<a href='http://localhost:8080/argus/#/viewmetrics?expression=-1h%3Aargus.jvm%3Acores.active%3Amax'>Click" +
    ...
    private Alert getAlert() {
        return new Alert(principalUserMock, principalUserMock, ALERT_NAME, "-1h:"+METRIC_NAME,
                "* * * * *");
    }

    private Notification getNotification(String notificationName, String notifierName, Alert alert) {
    ...
    private History getHistory() {
        return new History("TEST HISTORY MESSAGE", HOST_NAME, new BigInteger("100002"),
