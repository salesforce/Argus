...
public class EmailNotifierTest {
    ...
    public void setup() {
        ...
        notificationContext = new NotificationContext(alert, trigger, notification,
                TRIGGER_FIRED_TIME_SECONDS*1000, TRIGGER_EVENT_VALUE, metric, history, Pair.of(IMAGE_ID, IMAGE_BYTE_ARRAY), IMAGE_URL);
    }
