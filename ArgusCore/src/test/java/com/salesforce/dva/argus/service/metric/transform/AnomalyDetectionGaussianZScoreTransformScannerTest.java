...
public class AnomalyDetectionGaussianZScoreTransformScannerTest extends AbstractTest {
	...
	public void testCalculateAnomalyScore() {
		...
		AnomalyDetectionGaussianZScoreTransform transformMetric = new AnomalyDetectionGaussianZScoreTransform();
		AnomalyDetectionGaussianZScoreTransform transformScanner = new AnomalyDetectionGaussianZScoreTransform();
