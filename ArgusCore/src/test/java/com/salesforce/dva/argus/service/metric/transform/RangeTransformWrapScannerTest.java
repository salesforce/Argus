...
public class RangeTransformWrapScannerTest extends AbstractTest {
	...
	@Test
	public void testTransformWithoutNull() {
		...
		RangeTransformWrap transform = new RangeTransformWrap();
	...
	public void testPagerMultiple() {
		...
		Transform transform = new RangeTransformWrap();
	...
	public void testPagerSingle() {
		...
		for (int i = 0; i < scanners.size(); i++) {
			...
			List<Metric> mList = Arrays.asList(metrics.get(i));
			List<MetricScanner> msList = Arrays.asList(scanners.get(i));
