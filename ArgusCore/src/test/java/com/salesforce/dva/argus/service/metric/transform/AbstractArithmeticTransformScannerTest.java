...
public class AbstractArithmeticTransformScannerTest extends AbstractTest {
	...
	public void testAbstractTransform() {
		...
		AbstractArithmeticTransform transform = new AbstractArithmeticTransformExtensionForScannerTest();
	...
	@Test
	public void testDisposingWhenFinished() {
	...
	public void testPager() {
		...
		Transform transform = new AbstractArithmeticTransformExtensionForScannerTest();
