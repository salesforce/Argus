...
public class MetricReducerOrMappingWithConstantTransformScannerTest extends AbstractTest {
	...
	@Test
	public void testTransformWithSumMultipleConstantsPercentileMappingSmallWindowWithoutNull() {
		...
		MetricReducerOrMappingWithConstantTransform transform = new MetricReducerOrMappingWithConstantTransform(new PercentileValueReducerOrMapping());
		List<String> constants = new ArrayList<>();
		constants.add("75.0");
		constants.add("2m"); // add the tolerance value for the deviation
	...
	@Test
	public void testTransformWithSumMultipleConstantsPercentileMappingLargeWindowWithoutNull() {
		...
		List<String> constants = new ArrayList<>();
		constants.add("75.0");
		constants.add("2h"); // add the tolerance value for the deviation
	...
	public void testPager() {
		...
		Transform transform = new MetricReducerOrMappingWithConstantTransform(new PercentileValueReducerOrMapping());
		List<String> constants = new ArrayList<>();
		constants.add("90.0");	
