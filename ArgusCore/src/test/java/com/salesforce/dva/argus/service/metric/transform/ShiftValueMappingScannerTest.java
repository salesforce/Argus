...
public class ShiftValueMappingScannerTest extends AbstractTest {
	...
	@Test
	public void testMappingWithoutNullAndPositiveShift() {
		...
		ShiftValueMapping map = new ShiftValueMapping();
	...
	@Test
	public void testMappingWithoutNullAndNegativeShift() {
	...
	@Test
	public void testMappingWithNullAndPositiveShift() {
	...
	@Test
	public void testMappingWithNullAndNegativeShift() {
	...
	public void testPager() {
		...
		for (int i = 0; i < scanners.size(); i++) {
			...
			assert(expected.subMap(start + (2 * 60 * 1000), end + 1 + 2 * 60 * 1000).equals(stream.getDPChunk(chunk)));			
